...
/**
 * @minions-projects/cli — CLI for Minions Projects
 *
...
import { customTypes } from '@minions-projects/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Projects'));
        console.log(chalk.dim('Project definitions, variants, goals, status, and ownership'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-projects/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-projects/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-projects')}`);
