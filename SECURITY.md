...
- `@minions-projects/sdk` (npm package)
- `minions-projects` (PyPI package)
- `@minions-projects/cli` (npm package)
- The minions-projects web playground
- The minions-projects documentation site
